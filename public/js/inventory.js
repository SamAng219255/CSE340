...
let classificationElem = document.getElementById("classification-select")
classificationElem.addEventListener("change", function () {
  let classification_id = classificationElem.value
